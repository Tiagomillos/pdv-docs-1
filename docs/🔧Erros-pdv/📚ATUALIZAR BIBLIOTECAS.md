...
📌 **Observações**  
• Executar conforme a arquitetura do PDV (32 / 64 bits)  
• Garantir conectividade antes de iniciar os downloads  
• Após atualizar, reiniciar o PDV se necessário